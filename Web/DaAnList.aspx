<%@ Page Title="" Language="C#" MasterPageFile="~/web.Master" AutoEventWireup="true" CodeBehind="DaAnList.aspx.cs" Inherits="Web.DaAnList" %>
            ...
            <div class="content">
                ...
                <div class="exam-rightArea">
                    <div class="result-operate">
                        ...
                        <ul>
                            <li><a href="ExamResult.aspx">查看报告</a></li>
                        </ul>
                    </div>
                </div>
