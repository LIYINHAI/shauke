     ...
     <div class="top-title">
         ...
         <table class="table" style="border-collapse:separate; border-spacing:0px 20px; ">
            ...
            <asp:ListView ID="ListView1" runat="server">
                <ItemTemplate>                                
            <tr class="tr2">
                    <td><asp:HyperLink ID="hp1"  runat="server" ForeColor="Black" CssClass="text" Text='<%# SplitChar(Eval("UserName").ToString(),10) %>' ></asp:HyperLink></td>
                    <td><asp:Label ID="AssID" runat="server" Text='<%#Eval("Password") %>'></asp:Label></td>                    
                  <%--  <td ><asp:Label ID="content" runat="server" Text='<%# SplitChar(Eval("ActContent").ToString(),15)%>'></asp:Label></td>  --%> 
                    <td ><asp:Label ID="acttime" runat="server" Text='<%#Eval("Email") %>'></asp:Label></td>     
                    <td ><asp:Label ID="endtime" runat="server" Text='<%#Eval("Phone") %>'></asp:Label></td>            
                    <td>
