...
namespace Web
{
    public partial class admincou : System.Web.UI.Page
    {
        ...
        protected void btnDelete_Click(object sender, EventArgs e)
        {
            ...
            int couid = Convert.ToInt32(((HiddenField)(bt.Parent.FindControl("HiddenField1"))).Value);
            if (VideoService.DeleteAct(couid) > 0)
            {
